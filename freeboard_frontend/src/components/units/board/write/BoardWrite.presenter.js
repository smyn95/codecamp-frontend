...
return(
  <S.Box>
    ...
    <S.Textbx>
      ...
      <S.Titlebx>
       <S.Font>비밀번호</S.Font>
       <S.Input type="text" onChange={props.onChangePassword} placeholder="비밀번호를 입력해주세요." />
      </S.Titlebx>
    </S.Textbx>
    <S.Textbx>
     <S.Titlebx>
       <S.Font>제&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;목</S.Font>
       <S.Input type="text" onChange={props.onChangeTitle} placeholder="제목을 작성해주세요." defaultValue={props.data?.fetchBoard.title}/>
      </S.Titlebx>
    </S.Textbx>
    <S.Textbx>
     <S.Titlebx>
       <S.Font>내&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;용</S.Font>
       <S.Contents type="text" onChange={props.onChangeContents} placeholder="내용을 작성해주세요." defaultValue={props.data?.fetchBoard.contents}/>
      </S.Titlebx>
    </S.Textbx>
    ...
    <S.Textbx>
     <S.Titlebx>
       <S.Font>주&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;소</S.Font>
       <S.Codezip type="text" placeholder="00000" onChange={props.onChangeZipcode} defaultValue={props.data?.fetchBoard.zipcode}/>
    ...
    <S.Textbx>
     <S.Titlebx>
       <S.Font>유&nbsp;튜&nbsp;브</S.Font>
       <S.Input type="text" placeholder="링크를 복사해주세요." onChange={props.onChangeYoutubeUrl}/>
      </S.Titlebx>
    </S.Textbx>
    <S.Textbx>
      <S.Titlebx>
