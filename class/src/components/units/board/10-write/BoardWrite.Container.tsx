...
import { CREATE_BOARD, UPDATE_BOARD } from "./BoardWrite.queryes";
...
export default function  BoardWrite(props : IBoardWriteProps) {
  ...
  const onClickSubmit = async () => {
    ...
    router.push(`/10-01-boards/${result.data.createBoard.number}`)
  }
  ...
  const onClickUpdate= async() => {
    ...
    router.push(`/10-01-boards/${result.data.updateBoard.number}`)
  }
